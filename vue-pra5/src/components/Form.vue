...
onMounted(async () => {
  ...
  try {
    const response = await axios.get('https://vue-exa-default-rtdb.firebaseio.com/surveys.json')
...
const onSubmit = (e: Event) => {
  // fetch('https://vue-exa-default-rtdb.firebaseio.com/surveys.json', {
  //   method: 'POST',
  //   headers: {'Content-Type': 'application/json'
  //   },
  //   body: JSON.stringify({name: userName.value, interest: interest.value})
  // })
  axios.post('https://vue-exa-default-rtdb.firebaseio.com/surveys.json', {
    name: userName.value,
